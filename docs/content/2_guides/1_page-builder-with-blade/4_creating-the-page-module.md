...
Luckily, Twill comes with a few useful [artisan](https://laravel.com/docs/11.x/artisan) commands. (Artisan is the command
...
[official documentation](https://laravel.com/docs/11.x/providers).
...
`TwillNavigation` is a [Facade](https://laravel.com/docs/11.x/facades#main-content) that Twill provides to manage the
administration menu.
