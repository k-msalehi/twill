...
For the installation of Laravel, we will use some steps from the [official documentation](https://laravel.com/docs/11.x).
...
If you do not have MySQL setup, you can use [SQLite](https://laravel.com/docs/11.x#databases-and-migrations) as well.
